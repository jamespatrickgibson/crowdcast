...
Stolen from: https://www.pyimagesearch.com/2018/08/13/opencv-people-counter/
'''
# USAGE
...
ap.add_argument("-i", "--input", type=str, default='videos/peopleCount1.mp4',
...
ap.add_argument("-l", "--log", type=str, default='DEBUG',
...
logging.basicConfig(filename='peopleCounter.log',level=numeric_level)
